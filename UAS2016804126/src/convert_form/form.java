...
rumus convert;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Conversi Bilangan");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtdesimal, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(138, 138, 138)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(hexa)
...
private void convertBilangan() {
    String n1;
    String x = txtdesimal.getText();
    n1 = txtdesimal.getText();
    if (biner.isSelected()) {
        int hasil = 0;
        if (x != null && x.trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Angka harus diisi!") ;
        }
        else {
            int desimal = Integer.parseInt(n1);
            hasil = convert.rumus(desimal);
            txtconvert.setEditable(false);
            txtconvert.setText(String.valueOf(hasil));
        }
    }
